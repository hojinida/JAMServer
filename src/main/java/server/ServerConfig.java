...
public class ServerConfig {
  ...
  public static final int MAX_ACCEPTS_PER_LOOP = 64;
  ...
  public static final int REQUEST_HEADER_SIZE = REQUEST_ID_SIZE + ITERATIONS_SIZE + DATA_LENGTH_SIZE;
  public static final int RESPONSE_PAYLOAD_SIZE = REQUEST_ID_SIZE + ITERATIONS_SIZE + DATA_LENGTH_SIZE + HASH_RESULT_SIZE;
